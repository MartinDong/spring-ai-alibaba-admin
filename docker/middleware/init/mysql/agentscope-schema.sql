...
/******************************************/
/*   table = a2a_remote_agent             */
/******************************************/
DROP TABLE IF EXISTS `a2a_remote_agent`;
CREATE TABLE `a2a_remote_agent`
(
    `id`               BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
    `gmt_create`       DATETIME            NOT NULL COMMENT 'create time',
    `gmt_modified`     DATETIME            NOT NULL COMMENT 'modified time',
...
/******************************************/
/*   table = a2a_agent_publication        */
/******************************************/
DROP TABLE IF EXISTS `a2a_agent_publication`;
CREATE TABLE `a2a_agent_publication`
(
    `id`               BIGINT(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'pk',
    `gmt_create`       DATETIME            NOT NULL COMMENT 'create time',
    `gmt_modified`     DATETIME            NOT NULL COMMENT 'modified time',
